...
import time #Allows us to thread or pause an execution of a particular program
import getpass as gp #hide the password from the console
import util #import the script util.py
import encrypt #import the script encrypt.py
import re
import shutil
...
#This function display the option keys we see on the welcome page
def select_options():
    global option
...
#This function dispaly specific operation options in the application
def encrypt_options():
    global option
    global email
    global passwd
