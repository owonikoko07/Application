...
8%: Lecturer provided enc.py
2%: https://stackoverflow.com/questions/1855095/how-to-create-a-zip-archive-of-a-directory
All comments are original..........
"""

import util #import the script util.py
import os #No of processor, CPUgiven by OS
import shutil #Operation on folders
import time
from secrets import token_bytes #Allow us to generate byte of data
...
import app #import the script app.py

#This function prompt the user to input the file to be encrypt and pass the parameter
#the parameter(email,secret) to the encryption function
...
#Pass the parameter(email,secret,arv,file_path) to the encryption function
...
#This function display the information for the User during decryption process and remove file in the list of arrays.
def decrypt(email,secret):
    ...
    for i, v in enumerate(arr):
        ...
        print(f"{v['id']}. {v['name']}\t{v['type']}".expandtabs(8))
